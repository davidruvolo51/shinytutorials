...
2.  [How does it work?](#work)
    - [Why doesn't this work in the first place](#work-notwork)
    - [Preparing our UI](#work-ui)
    - [Using JavaScript](#work-js)
    - [Implementing the JavaScript function](#work-implementation)
