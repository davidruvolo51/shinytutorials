...
A data editor would be useful as this would
...
updating information, etc.) on the fly rather than writting script to recode a value at column X, row Y. 
...
![a video showing how to edit and save changes in a data table](https://raw.githubusercontent.com/davidruvolo51/shinyAppTutorials/master/Data-Editor/data-editor.gif)
...
shinyJS packages. In this example, we will using the `mtcars`
dataset.
